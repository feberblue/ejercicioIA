...
model = Sequential()
model.add(Dense(64, activation='relu', input_shape=(X_train_scaled.shape[1],))) # capa de entrada con 64 Neuronas
...
model.add(Dense(1, activation='sigmoid')) # Salida con funcion de activacion (salida binaria)3
